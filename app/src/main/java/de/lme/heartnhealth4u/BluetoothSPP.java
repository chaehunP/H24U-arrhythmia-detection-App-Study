...
public class BluetoothSPP {
    ...
    public static OnDataReceivedListener mDataReceivedListener = null;
    ...
    public static String[] bufferdata;

    public static ConcurrentLinkedQueue<String> dataq = new ConcurrentLinkedQueue<String>();
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case BluetoothState.MESSAGE_READ:
                    ...
                    readMessage = new String(readBuf); //byte 배열을 String으로 변환

                    dataq.add(readMessage);  //ConcurrentLinkedQueue<String>
                    DATA.add(readMessage);   //ArrayList<String>, 리스트에 값 추가 add 함수
